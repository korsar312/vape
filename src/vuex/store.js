...
const store = createStore({
                    ...
                    items(){
                        return [
                            ...
                            },
                            {
                                ...
                                price: 100,
                                id: '01016',
                                descript: 'Волшебная жидкость от дяди Вовы славящаеся своими вкусовыми качествами и разнообразием никотина. От 20 мг обычного до 40 мг солевого',
                            },
                            {
                                name: 'Nictech',
                                img: '/liq_Nictech.jpg',
    ...
    mutations: {
        ...
        setCookie(state){
            document.cookie = ("Basket:" + state.itemInBasket.map(i=>i.id)) + 'endBasket'
        },
        getCookie(state){
            ...
            for(let i of cookie){
                for(let j of arr){
                    ...
                    i == j.id ? state.itemInBasket.push(j) : ''
                }
            }
        }
    },
